  ...
  const galleryImages = [
    {
      ...
      description: 'Youth champions led a massive community march against substance abuse, alcohol, and gender-based violence. With colorful placards and banner displays showcasing the NGO\'s mission, they mobilized over 500 community members across multiple locations.',
    ...
    },
    {
      ...
      category: 'Community Awareness',
      description: 'Young advocates participated in an organized community walk carrying empowering messages about zero tolerance for substance abuse and its effects. The participants engaged in peer-to-peer conversations with community members about health risks.',
    ...
    },
    {
      ...
      category: 'Community Awareness',
      description: 'A large-scale community outreach event combining youth leadership with government partnership for substance abuse prevention. Youth advocates distributed educational materials and shared personal stories to build community resilience against drug addiction.',
    ...
    },
    {
      ...
      category: 'Health',
      description: 'Youth leaders from Kisii University collaborated with the National AIDS Control Council in a commemorative march celebrating progress in HIV prevention and care. Participants shared messages of hope and unity for affected communities.',
    ...
    },
    {
      ...
      category: 'Health',
      description: 'A landmark community event where thousands marched in solidarity to advocate for mental health awareness and break stigma. The march united government officials, healthcare workers, teachers, and youth to promote mental wellness and community support.',
    ...
    },
    {
      ...
      category: 'Health',
      description: 'Youth advocates partnered with the Kenya Counselling and Psychological Association in a national mental health walk promoting wellness and resilience. Participants marched through communities spreading messages about the importance of mental health care.',
    ...
    },
    {
      ...
      category: 'Health',
      description: 'Young advocates conducted community outreach promoting mental health awareness with focus messages on stress management and emotional wellbeing. Presenters shared strategies for healthy living while addressing stigma around mental health challenges.',
    ...
    },
    {
      ...
      category: 'Support',
      description: 'Youth leaders facilitated open community dialogues addressing stress, mental health, and healthy coping mechanisms. In safe spaces, participants shared experiences and learned practical techniques for emotional wellness.',
    ...
    },
    {
      ...
      category: 'Support',
      description: 'Trained peer counselors conducted confidential one-on-one sessions under sheltered spaces, providing listening support and basic mental health guidance to individuals facing personal challenges. Sessions included initial assessment and referral to professional services when needed.',
              ...
              {galleryImages.map((item, index) => (
                ...
                >
                  ...
                  <div className="p-6" style={{ backgroundColor: '#050F2A' }}>
                    ...
                    <p className="text-sm leading-relaxed mb-4" style={{ color: '#E8F4FF' }}>{item.description}</p>
                  </div>
                  ...
                  {/* Results at bottom */}
                  <div className="p-6" style={{ backgroundColor: '#050F2A' }}>
                    <p className="text-sm leading-relaxed" style={{ color: '#7BBBFF' }}>
                      <span className="font-bold" style={{ color: '#7EBBBF' }}>Results:</span> {item.results}
                    </p>
                  </div>
                </div>
              ))}
